...
----------------
Lvl 25 :-
To be honest, This challenge took me a while to figure out (I think because I use a tiling window manager), but never mind
when we enter the ssh session we will find an ssh key to use in order to connect to 
